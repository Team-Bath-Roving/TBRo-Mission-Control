...
class GamepadManager:
	...
	def add_gamepad(self, index:int):
		...
		----------
		index : int
			The device index for the gamepad
		"""
		gamepad = Gamepad(index)
		self.gamepads[gamepad.joystick.get_instance_id()] = gamepad

	def remove_gamepad(self, id:int):
		"""
		Parameters
		----------
		id : int
	...
	def get_button_state(self, id:int, button:int):
		"""
		Gets the button state from a specified gamepad
...
class Gamepad:
	"""
	Stores information about a connected gamepad
	"""
